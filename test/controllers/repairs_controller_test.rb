...
class RepairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post repairs_url, params: { repair: { model_id: @repair.model_id, other: @repair.other, pick_date: @repair.pick_date, problem_id: @repair.problem_id } }
    end
  ...
  test "should update repair" do
    patch repair_url(@repair), params: { repair: { model_id: @repair.model_id, other: @repair.other, pick_date: @repair.pick_date, problem_id: @repair.problem_id } }
